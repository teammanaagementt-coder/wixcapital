      ...
      <nav className={`flex items-center justify-between px-8 md:px-14 h-[68px] sticky top-0 z-40 nav-blur transition-all duration-300 ${scrollY > 40 ? 'border-b border-[#1a1a28]' : ''}`}>
        ...
        <div className="flex gap-2.5 items-center">
          ...
          <div className="relative md:hidden" ref={dropdownRef}>
            ...
            {/* Finer Dropdown Menu */}
            {mobileDropdownOpen && (
              <div className="dropdown-animate absolute right-0 mt-2 w-56 rounded-xl border border-[#1e1e30] bg-[#0c0c16]/95 backdrop-blur-xl shadow-2xl shadow-black/40 z-50 overflow-hidden">
                <div className="py-2">
                  {navLinks.map(link => (
                    <Link
                      key={link.to}
                      ...
                      className="flex items-center px-4 py-2.5 text-[13px] font-medium text-[#b0b0c8] hover:text-[#00c896] hover:bg-[rgba(0,200,150,0.08)] transition-colors duration-150"
                    >
                      {link.label}
                    </Link>
                  ))}
                  <div className="my-2 h-px bg-[#1e1e30]" />
                  <Link
                    to="/login"
                    onClick={() => setMobileDropdownOpen(false)}
                    className="flex items-center px-4 py-2.5 text-[13px] font-medium text-[#b0b0c8] hover:text-[#00c896] hover:bg-[rgba(0,200,150,0.08)] transition-colors duration-150"
                  ...
                  <Link
                    to="/register"
                    onClick={() => setMobileDropdownOpen(false)}
                    className="mx-3 mt-2 mb-1 block rounded-lg bg-[#00c896] px-3 py-2 text-center text-[12px] font-extrabold text-black transition-all hover:bg-[#00dea8] hover:shadow-[0_0_12px_rgba(0,200,150,0.3)]"
                  >
                    Get Started
                  </Link>
                </div>
